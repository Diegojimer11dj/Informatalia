...
<body id="body">
    ...
    <div class="introduccion">
        <h2>Teléfonos</h2><br>
        <p class="descripcion well well-lg">¡Encuentra los mejores teléfonos en nuestra tienda online! Ofrecemos smartphones de marcas líderes en el mercado, con pantallas vibrantes, potentes procesadores y cámaras de alta resolución. Nuestros modelos cuentan con características adicionales como reconocimiento facial, huella dactilar y asistentes de voz. Disfruta de una experiencia multimedia excepcional y conexión rápida con las últimas redes de datos móviles. Nuestra tienda ofrece una experiencia de compra fácil y segura, con un equipo de atención al cliente disponible para ayudarte. ¡Actualiza tu dispositivo y experimenta lo último en tecnología con nuestros teléfonos!</p>
    </div>
    ...
    <div class="productos">
        ...
        <?php
            if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["filtrar"])) {
                ...
                $sql = "SELECT * FROM productos WHERE Categoria = 'Telefonos'";
            }
            $resultados = mysqli_query($bd, $sql);
            foreach ($resultados as $fila) {
            ?>
